...
public class TicketStatusComparator implements Comparator<Ticket>{
	...
	public int compare(Ticket o1, Ticket o2) {
		return TicketEnums.PriorityEnum.toInt(TicketEnums.PriorityEnum.fromString(o1.getStatus())) - 
				TicketEnums.PriorityEnum.toInt(TicketEnums.PriorityEnum.fromString(o2.getStatus()));
	}
